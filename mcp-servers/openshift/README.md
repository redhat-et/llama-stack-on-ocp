...
- Provide a suitable user query to test. You can find an example in `mcp-servers/openshift/prompts.txt` and pass it [here](https://github.com/redhat-et/llama-stack-on-ocp/blob/main/app/src/0_simple_agent.py#L74)
